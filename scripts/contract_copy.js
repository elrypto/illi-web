...
const ethContractName = 'IlliEth.json';
const ethContractSource = './../illi-eth/build/contracts/';
const ethContractDestination = './src/contracts/';
const sideChainContractName = 'IlliApp.json';
const sideChainContractSource = './../illi-schain/build/contracts/';
